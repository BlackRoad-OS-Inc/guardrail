...
- [ ] [RC] Integrate guardrail with RoundTrip hub (roundtrip.blackroad.io) for agent coordination
- [ ] [RC] Register GuardRail Agent in the BlackRoad Agent OS roster (~/.blackroad-agents/)
- [ ] [RC] Deploy guardrail to Pi fleet node: Alice (.49)
...
- [ ] [RC] Add NLP intent triggers: 'check status' / 'is X up'
...
## Upstream Sync
- [ ] Track upstream Uptime Kuma releases
